# 🎮 Pokémon - Banner Interactivo con Realidad Aumentada# 🎮 Pokémon - Banner Interactivo con Realidad Aumentada



![Pokémon](https://img.shields.io/badge/Pokémon-Project-yellow?style=for-the-badge&logo=pokemon)![Pokémon](https://img.shields.io/badge/Pokémon-Project-yellow?style=for-the-badge&logo=pokemon)
...
![A-Frame](https://img.shields.io/badge/A--Frame-EF2D5E?style=for-the-badge&logo=aframe&logoColor=white)![A-Frame](https://img.shields.io/badge/A--Frame-EF2D5E?style=for-the-badge&logo=aframe&logoColor=white)
...
## ✨ Características Implementadas- ✅ **Banner Hero Animado**: Sección principal con gradientes dinámicos y efectos visuales
...
- ✅ **Información oficial completa** de la serie Pokémon (temporadas, episodios, películas, personajes, regiones)- ✅ **Modelo 3D de Pikachu**: Visualización interactiva en 3D con controles de rotación y animaciones de flotación

- ✅ **Galería de 6 personajes** con animaciones y efectos hover- ✅ **Realidad Aumentada Sin Marcadores**: Experiencia AR moderna sin necesidad de códigos QR, usando la cámara del dispositivo

- ✅ **Modelo 3D de Pikachu** creado con A-Frame, con rotación automática y flotación- ✅ **Diseño 100% Responsive**: Adaptable a móviles, tablets y desktop con múltiples breakpoints

- ✅ **Controles interactivos** para rotar el modelo 3D (mouse en PC, touch en móvil)- ✅ **Navegación Fluida**: Scroll suave entre secciones con animaciones

- ✅ **Realidad Aumentada** con acceso a cámara del dispositivo- ✅ **Código Limpio**: Separación correcta de responsabilidades (HTML, CSS, JavaScript)

- ✅ **Diseño 100% responsive** con múltiples breakpoints para móviles y tablets- ✅ **Publicado en GitHub Pages**: Accesible públicamente
...
## 🛠️ Tecnologías Utilizadas- **JavaScript ES6+**: Interactividad, event listeners y manejo de eventos sin código inline



### Frontend### Frameworks y Librerías

- **HTML5**: Estructura semántica- **[A-Frame 1.4.2](https://aframe.io/)**: Framework para experiencias 3D y VR en la web

- **CSS3**: Grid, Flexbox, animaciones, variables CSS- **[AR.js](https://ar-js-org.github.io/AR.js/)**: Biblioteca de Realidad Aumentada basada en WebRTC

- **JavaScript ES6+**: Event listeners, animaciones, gestión de AR

### Buenas Prácticas Implementadas

### Librerías- ✅ Separación completa de HTML, CSS y JavaScript

- **A-Frame 1.4.2**: Framework para 3D en la web- ✅ Sin código inline (`onclick`, `style=""`)

- **AR.js**: Realidad Aumentada con WebRTC- ✅ Event listeners centralizados en JavaScript
...
## 🚀 Ver el Proyecto## 🚀 Instalación y Uso



### Acceso Directo (GitHub Pages)### Opción 1: Acceso Directo (GitHub Pages)
...
git clone https://github.com/xsebastv/Banner-con-RA.git### Opción 2: Uso Local
...
1. **Clic en "Activar Realidad Aumentada"**   - Abre `index.html` directamente en tu navegador

2. **Permitir acceso a la cámara** cuando el navegador lo solicite   - O usa Live Server en VS Code para desarrollo

3. **Mover el dispositivo** para ver a Pikachu en tu entorno

4. **Pikachu rotará y flotará automáticamente**## 📱 Cómo Usar la Realidad Aumentada

5. **Clic en "✕ Cerrar"** para salir

### AR Sin Marcadores (Moderna)

### Requisitos

- Navegador moderno (Chrome 90+, Safari 14+)1. **Activa la RA**: Haz clic en **"Activar Realidad Aumentada"**

- Dispositivo con cámara2. **Permite la cámara**: Acepta el acceso cuando el navegador lo solicite
...
## 📂 Estructura del Proyecto### 📋 Requisitos para AR

- ✅ Navegador moderno (Chrome 90+, Safari 14+, Firefox 88+)

```- ✅ Dispositivo con cámara (móvil preferido)

Banner-con-RA/- ✅ Conexión HTTPS (GitHub Pages incluido)

├── index.html    # Estructura HTML- ✅ Buena iluminación ambiental

├── styles.css    # Estilos y responsive

├── script.js     # Interactividad y AR## 📂 Estructura del Proyecto
...
## 🎨 Diseño Responsive├── script.js               # JavaScript (comportamiento)
...
- **Landscape**: Modo horizontal optimizado### 🎨 Paleta de Colores Oficial

- **Amarillo Pokémon**: `#FFDE00` (Pikachu)

### Paleta de Colores- **Azul Pokémon**: `#3B4CCA` (Logo oficial)

- Amarillo Pokémon: `#FFDE00`- **Rojo Pokéball**: `#FF1C1C`

- Azul Pokémon: `#3B4CCA`- **Azul Claro**: `#6EABFF`

- Rojo: `#FF1C1C`- **Fondo Claro**: `#F0F8FF`
...
| Chrome 90+    | ✅ | ✅ | Completo |### ✨ Animaciones y Efectos

| Safari 14+    | ✅ | ✅ | Completo |- Transiciones suaves entre secciones

| Firefox 88+   | ✅ | ⚠️ | 3D OK |- Rotación automática del modelo 3D (360°)

| Edge 90+      | ✅ | ✅ | Completo |- Hover effects en tarjetas con escala y rotación

- Animación de flotación en Pikachu

**Dispositivos probados:**- Scroll smooth navigation

- ✅ Desktop (Windows, macOS)- Fade in on scroll para tarjetas

- ✅ iPhone (iOS 14+)

- ✅ Android (Chrome)## 💻 Compatibilidad
